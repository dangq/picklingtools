...
//
///////////////////////////////////////////////////////////////////////////////
void sendT4Tab(CPHEADER& hcb, const Tab& t, string vrb_key)
{
	sendT4Val(hcb, t, vrb_key);
}
...
//
///////////////////////////////////////////////////////////////////////////////
bool recvT4Tab(CPHEADER& hcb, Tab& t, string vrb_key)
{
  Val v;
	if (recvT4Val(hcb, v, vrb_key)) {
		if (v.tag == 't') {
			t = v;
			return true;
		}
