...
BIGINT StringToBigUIntHelper (const char* data, int len=-1, Allocator *a=0);
...
template <class BIGINT>
inline BIGINT StringToBigUIntHelper (const char* data, int len, Allocator* a)
{
...
{ return StringToBigUInt(data, int(strlen(data)), a); }

inline int_un StringToBigUInt (const string& s, Allocator *a=0)
{ return StringToBigUInt(s.data(), int(s.length()), a); }
