...
class MyServer(MidasServer) :
    ...
    def __init__ (self, have_server_send_mesg_at_connect,
                  host, port, ser, dual_socket, dis) :
        MidasServer.__init__(self, host, port, ser, dual_socket, dis)
        self.count = 0
