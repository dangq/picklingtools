...
if __name__ == '__main__' :
  ...
  try :
    ...
    print "Usage: permutation_client.py [--ser=0|1|2|-2] [--sock=1|2] [--arrdisp=0|1|2] host port array_of_data_to_permute"
    print " Example usage:"
  ...
  mt = MidasTalker(host, port, serialization, dual_socket, array_disposition)  
