...
{
  cerr << "usage: " << string(name) << " [--ser=0|1|2|-2|4|5|6|7|8] [--sock=1|2] [--arrdisp=0|1|2] [--convert=1] hostname portnumber" << endl;
...
int main (int argc, char *argv[])
{
  ...
  MidasTalker mt(host, port, serialization, dual_socket, array_disposition);
  if (convert) {
